        ...
        <div id="tabs-1">
            <div class="block">
                ...
                <table class="floated-form-table form-table">
                    ...
                    <tr valign="top">
                        <th scope="row">First occurrence only?</th>
                        <td>
                        ...
                        <td colspan="2" class="cmcrpr_field_help_container">Select this option if you want to only take into account the first occurrence of each item on a page/post.</td>
                    </tr>
					<tr valign="top">
                ...
                <table class="floated-form-table form-table">
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="cmcrpr_options[enableCaching]" <?php checked( true, CMCRPR_Base::_getOptions( 'enableCaching' ) ); ?> value="1" />
                        </td>
...
<!--                    </tr>-->
 ...
 <div id="tabs-88">
    ...
    <ul style="list-style-type:disc;margin-left:20px;">
        <li><strong>Exclude from parsing</strong> - [cmcrpr_exclude] text [/cmcrpr_exclude]</li>
    </ul>
  </td>
                        </tr>
                    </tbody></table>
